...
const Navbar = () => {
  ...
  return (
    <header className="relative z-20 w-full shadow-slate-700/5 after:absolute after:top-full after:left-0 after:z-10 after:block after:h-px after:w-full after:bg-slate-800 lg:backdrop-blur-sm lg:after:hidden">
      <div className="relative mx-auto max-w-full px-2 lg:px-0 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem]">
        <nav
